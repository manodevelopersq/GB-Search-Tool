...
chrome.storage.local.get(['blockedUsers','blockedPatterns','blockedWords'], (result) => {
...
async function save() {
    ...
    await chrome.storage.local.set({blockedUsers : newBlockedUsers, blockedWords : newBlockedWords, blockedPatterns : newBlockedPatterns})
}
